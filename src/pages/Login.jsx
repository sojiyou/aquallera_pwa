...
export default function Login() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-b from-blue to-midnight-blue relative overflow-hidden">
      <svg className="absolute inset-0 w-full h-full opacity-10" viewBox="0 0 1440 900" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex-1 overflow-y-auto relative z-10">
        <div className="flex flex-col items-center pt-8">
          <img src="/logo-no-name.png" alt="Aquallera Logo" className="w-[200px] h-[200px] object-contain mb-6" />
