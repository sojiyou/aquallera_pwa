...
export default function Maps() {
  ...
  const getLabelFontSize = (zoom) => zoom < LABEL_MIN_ZOOM ? 0 : Math.max(15, Math.min(23, 11 + (zoom - LABEL_MIN_ZOOM) * 2.1))
  ...
  return (
    <div className="h-dvh flex flex-col bg-app-bg">
      <div className="flex items-center gap-3 px-3 py-2 bg-app-bg shrink-0 z-30">
        ...
        <button onClick={() => setShowHowToOrder(true)} className="btn-primary text-[18px] px-2.5 py-1.5 leading-none">How to Order</button>
      </div>
