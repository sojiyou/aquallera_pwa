      ...
      <div className="flex-1 p-4 space-y-4 overflow-y-auto">
        ...
        <div className="card">
          ...
          <label className="relative flex items-center w-full h-14 px-4 rounded-lg bg-[#D9D9D9] cursor-pointer active:scale-[0.98] transition-transform">
            <svg className="w-5 h-5 mr-2 text-midnight-blue/60 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M3 10h18M8 2v4M16 2v4"/></svg>
            <span className={`flex-1 text-base ${preferredDate ? 'text-midnight-blue font-medium' : 'text-gray-500'}`}>
